...
typedef struct jawt_DrawingSurface {
    ...
    jint (__stdcall *Lock)
        (struct jawt_DrawingSurface* ds);
    JAWT_DrawingSurfaceInfo* (__stdcall *GetDrawingSurfaceInfo)
        (struct jawt_DrawingSurface* ds);
    void (__stdcall *FreeDrawingSurfaceInfo)
...
typedef struct jawt {
    jint version;
    JAWT_DrawingSurface* (__stdcall *GetDrawingSurface)
        (JNIEnv* env, jobject target);
    void (__stdcall *FreeDrawingSurface)
        (JAWT_DrawingSurface* ds);
    void (__stdcall *Lock)(JNIEnv* env);
    void (__stdcall *Unlock)(JNIEnv* env);
    jobject (__stdcall *GetComponent)(JNIEnv* env, void* platformInfo);
    jobject (__stdcall *CreateEmbeddedFrame) (JNIEnv *env, void* platformInfo);
    void (__stdcall *SetBounds) (JNIEnv *env, jobject embeddedFrame,
            jint x, jint y, jint w, jint h);
    void (__stdcall *SynthesizeWindowActivation) (JNIEnv *env,
            jobject embeddedFrame, jboolean doActivate);
} JAWT;
__declspec(dllimport)
jboolean __stdcall JAWT_GetAWT(JNIEnv* env, JAWT* awt);
